  ...
  if (screenshot) return (
    <button 
      ...
      style={{
        ...
        backgroundPosition: 'right bottom', // Essas duas linhas são utilizadas para redimensionar a imagem para aparecer somente a parte da tela
        backgroundSize: 96                 // com o widget, pois o restante da tela não tem conteúdo. Remover isso após adicionar conteúdo.                      
      }}
